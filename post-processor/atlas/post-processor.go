...
func (p *PostProcessor) PostProcess(ui packer.Ui, artifact packer.Artifact) (packer.Artifact, bool, error) {
	...
	if p.config.Type == "vagrant.box" {
		return nil, false, fmt.Errorf("As of June 27th, Vagrant-related functionality has been removed from Terraform\n" +
			...
			"Please replace the Atlas post-processor with the Vagrant Cloud post-processor. See\n" +
			"https://www.packer.io/docs/post-processors/vagrant-cloud.html for more detail\n")
	}
